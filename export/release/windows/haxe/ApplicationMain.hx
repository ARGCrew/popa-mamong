...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("idk", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("idk", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "120";
		app.meta["company"] = "h4mster";
		app.meta["file"] = "idk";
		app.meta["name"] = "IDK";
		app.meta["packageName"] = "com.h4mster.kok";
