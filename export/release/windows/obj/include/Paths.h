...
class HXCPP_CLASS_ATTRIBUTES Paths_obj : public ::hx::Object
{
	...
	public:
		...
		static ::String asset(::String file);
		static ::Dynamic asset_dyn();

		static  ::flixel::graphics::FlxGraphic graphic(::String file);
		static ::Dynamic graphic_dyn();

		static  ::openfl::media::Sound sound(::String file);
