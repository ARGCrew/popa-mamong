...
HX_DECLARE_STACK_FRAME(_hx_pos_5f636ea23ce47cfc_166_new)
...
class HXCPP_CLASS_ATTRIBUTES HaxeThread_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< HaxeThread_obj > __new( ::Dynamic h) {
			::hx::ObjectPtr< HaxeThread_obj > __this = new HaxeThread_obj();
			__this->__construct(h);
			return __this;
		}

		inline static ::hx::ObjectPtr< HaxeThread_obj > __alloc(::hx::Ctx *_hx_ctx, ::Dynamic h) {
...
HXDLIN( 166)		( ( ::sys::thread::_Thread::HaxeThread)(__this) )->handle = h;
            	}
