...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("idk",30,04,50,00),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("120",2f,5a,25,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("h4mster",ef,23,50,be));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("idk",30,04,50,00));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("IDK",10,a0,37,00));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.h4mster.kok",9b,ba,ec,71));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("IDK",10,a0,37,00))
