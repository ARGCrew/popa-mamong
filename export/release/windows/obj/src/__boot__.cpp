...
::haxeparser::HaxeParser_obj::__register();
...
::flixel::custom::_hx_system::FlxCrashHandler_obj::__register();
...
::NoteOffsetState_obj::__register();
...
::hxAddons::HxBitmapSprite_obj::__register();
...
::haxeparser::HaxeParser_obj::__boot();
