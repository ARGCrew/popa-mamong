...
HXDLIN( 449)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y);
...
HXLINE( 706)					{
HXLINE( 706)						 ::flixel::math::FlxBasePoint this1 = this->caret->offset;
HXDLIN( 706)						this1->set_x(this->caret->offset->set_y(( (Float)(0) )));
            					}
            				}
            				break;
...
HXLINE( 716)					{
HXLINE( 716)						 ::flixel::math::FlxBasePoint this1 = this->caret->offset;
HXDLIN( 716)						this1->set_x(this->caret->offset->set_y(this->borderSize));
            					}
            				}
            				break;
            			}
