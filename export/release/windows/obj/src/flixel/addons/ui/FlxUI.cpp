...
HXLINE(4278)							sprite->offset->set_x((sprite->offset->x - ( (Float)(text_x) )));
HXLINE(4279)							sprite->offset->set_y((sprite->offset->y - ( (Float)(text_y) )));
...
HXLINE(4299)			 ::flixel::addons::ui::FlxUIText fh = ( ( ::flixel::addons::ui::FlxUIText)(fbu->label) );
HXDLIN(4299)			fh->offset->set_x((fh->offset->x - ( (Float)(text_x) )));
HXLINE(4300)			 ::flixel::addons::ui::FlxUIText fh1 = ( ( ::flixel::addons::ui::FlxUIText)(fbu->label) );
HXDLIN(4300)			fh1->offset->set_y((fh1->offset->y - ( (Float)(text_y) )));
            		}
