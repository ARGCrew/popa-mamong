...
HXLINE( 268)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp = this->toggleButton;
HXDLIN( 268)			_hx_tmp->set_toggled(!(this->get_visible()));
            		}
HXLINE( 270)		bool _hx_tmp1;
HXDLIN( 270)		if (this->get_visible()) {
HXLINE( 270)			_hx_tmp1 = this->_alwaysOnTop;
            		}
            		else {
...
HXLINE( 359)					_hx_tmp2 = (mouseX <= this->_width);
            				}
            				else {
HXLINE( 359)					_hx_tmp2 = false;
            				}
HXDLIN( 359)				if (_hx_tmp2) {
HXLINE( 359)					_hx_tmp1 = (mouseY >= 0);
            				}
            				else {
HXLINE( 359)					_hx_tmp1 = false;
            				}
HXDLIN( 359)				if (_hx_tmp1) {
HXLINE( 359)					_hx_tmp = (mouseY <= this->_height);
            				}
            				else {
...
HXLINE( 361)						_hx_tmp = (mouseY <= this->_header->get_height());
            					}
            					else {
HXLINE( 361)						_hx_tmp = false;
            					}
HXDLIN( 361)					this->_overHeader = _hx_tmp;
HXLINE( 362)					if (this->_resizable) {
HXLINE( 364)						bool _hx_tmp;
HXDLIN( 364)						int _hx_tmp1 = this->_width;
HXDLIN( 364)						if ((mouseX >= (( (Float)(_hx_tmp1) ) - this->_handle->get_width()))) {
HXLINE( 364)							int _hx_tmp1 = this->_height;
HXDLIN( 364)							_hx_tmp = (mouseY >= (( (Float)(_hx_tmp1) ) - this->_handle->get_height()));
            						}
            						else {
HXLINE( 364)							_hx_tmp = false;
            						}
HXDLIN( 364)						this->_overHandle = _hx_tmp;
            					}
            				}
            				else {
...
HXLINE( 433)			 ::openfl::display::Bitmap _hx_tmp = this->_handle;
HXDLIN( 433)			int _hx_tmp1 = this->_width;
HXDLIN( 433)			_hx_tmp->set_x((( (Float)(_hx_tmp1) ) - this->_handle->get_width()));
HXLINE( 434)			 ::openfl::display::Bitmap _hx_tmp2 = this->_handle;
HXDLIN( 434)			int _hx_tmp3 = this->_height;
HXDLIN( 434)			_hx_tmp2->set_y((( (Float)(_hx_tmp3) ) - this->_handle->get_height()));
            		}
HXLINE( 436)		if (::hx::IsNotNull( this->_closeButton )) {
HXLINE( 438)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp = this->_closeButton;
HXDLIN( 438)			int _hx_tmp1 = this->_width;
HXDLIN( 438)			_hx_tmp->set_x(((( (Float)(_hx_tmp1) ) - this->_closeButton->get_width()) - ( (Float)(3) )));
