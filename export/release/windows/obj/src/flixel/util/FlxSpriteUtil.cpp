...
HXLINE( 185)				_hx_tmp = (spriteBounds->y > (camera->scroll->x + (( (Float)(camera->height) ) - camera->viewMarginY)));
            			}
            			else {
...
HXLINE( 221)				_hx_tmp = ((spriteBounds->y + spriteBounds->height) > (camera->scroll->x + (( (Float)(camera->height) ) - camera->viewMarginY)));
            			}
            			else {
