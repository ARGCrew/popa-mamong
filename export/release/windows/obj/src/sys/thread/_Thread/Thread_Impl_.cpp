...
HX_LOCAL_STACK_FRAME(_hx_pos_1eb101978d3f352a_52_get_events,"sys.thread._Thread.Thread_Impl_","get_events",0x2940127e,"sys.thread._Thread.Thread_Impl_.get_events","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",52,0x5ec2eeb7)
HX_LOCAL_STACK_FRAME(_hx_pos_1eb101978d3f352a_60_initEventLoop,"sys.thread._Thread.Thread_Impl_","initEventLoop",0xf8094852,"sys.thread._Thread.Thread_Impl_.initEventLoop","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",60,0x5ec2eeb7)
HX_LOCAL_STACK_FRAME(_hx_pos_1eb101978d3f352a_65_processEvents,"sys.thread._Thread.Thread_Impl_","processEvents",0xf30238cc,"sys.thread._Thread.Thread_Impl_.processEvents","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",65,0x5ec2eeb7)
namespace sys{
namespace thread{
namespace _Thread{
...
bool Thread_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::sys::thread::EventLoop Thread_Impl__obj::get_events( ::sys::thread::_Thread::HaxeThread this1){
            	HX_GC_STACKFRAME(&_hx_pos_1eb101978d3f352a_52_get_events)
HXLINE(  53)		if (::hx::IsNull( this1->events )) {
HXLINE(  54)			HX_STACK_DO_THROW( ::sys::thread::NoEventLoopException_obj::__alloc( HX_CTX ,null(),null()));
            		}
HXLINE(  55)		return this1->events;
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Thread_Impl__obj,get_events,return )

void Thread_Impl__obj::initEventLoop(){
            	HX_GC_STACKFRAME(&_hx_pos_1eb101978d3f352a_60_initEventLoop)
HXDLIN(  60)		::sys::thread::_Thread::HaxeThread_obj::current()->events =  ::sys::thread::EventLoop_obj::__alloc( HX_CTX );
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(Thread_Impl__obj,initEventLoop,(void))

void Thread_Impl__obj::processEvents(){
            	HX_STACKFRAME(&_hx_pos_1eb101978d3f352a_65_processEvents)
HXDLIN(  65)		::sys::thread::_Thread::HaxeThread_obj::current()->events->loop();
            	}
...
bool Thread_Impl__obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"initEventLoop") ) { outValue = initEventLoop_dyn(); return true; }
