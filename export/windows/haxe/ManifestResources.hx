...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_strums_square_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_videos_intro_mp4 extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__embed_cursor_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__embed_fmod_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__embed_ico_logo128_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__embed_ico_logo16_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__embed_ico_logo256_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__embed_ico_logo32_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__embed_ico_logo600_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__embed_ico_logo64_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:image("embed/cursor.png") @:noCompletion #if display private #end class __ASSET__embed_cursor_png extends lime.graphics.Image {}
@:keep @:image("embed/fmod.png") @:noCompletion #if display private #end class __ASSET__embed_fmod_png extends lime.graphics.Image {}
@:keep @:image("embed/ico/logo128.png") @:noCompletion #if display private #end class __ASSET__embed_ico_logo128_png extends lime.graphics.Image {}
@:keep @:image("embed/ico/logo16.png") @:noCompletion #if display private #end class __ASSET__embed_ico_logo16_png extends lime.graphics.Image {}
@:keep @:image("embed/ico/logo256.png") @:noCompletion #if display private #end class __ASSET__embed_ico_logo256_png extends lime.graphics.Image {}
@:keep @:image("embed/ico/logo32.png") @:noCompletion #if display private #end class __ASSET__embed_ico_logo32_png extends lime.graphics.Image {}
@:keep @:image("embed/ico/logo600.png") @:noCompletion #if display private #end class __ASSET__embed_ico_logo600_png extends lime.graphics.Image {}
@:keep @:image("embed/ico/logo64.png") @:noCompletion #if display private #end class __ASSET__embed_ico_logo64_png extends lime.graphics.Image {}
