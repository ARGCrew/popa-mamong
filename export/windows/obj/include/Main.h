...
class HXCPP_CLASS_ATTRIBUTES Main_obj : public  ::flixel::FlxGame_obj
{
	public:
	...
	public:
		...
		void upgradeFullscreen();
		::Dynamic upgradeFullscreen_dyn();

		void onUncaughtError( ::openfl::events::UncaughtErrorEvent e);
		::Dynamic onUncaughtError_dyn();
