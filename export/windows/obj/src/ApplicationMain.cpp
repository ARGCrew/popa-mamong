...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("ARGame",83,25,46,63),::ApplicationMain_obj::create_dyn());
...
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("ARG Team",e7,16,ab,df));
...
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.ARGTeam.arg",ae,26,9b,31));
HXLINE(  43)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("0.1-dev",bb,1d,1e,85));
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Another Rhythm Game",ff,82,2c,ef))
