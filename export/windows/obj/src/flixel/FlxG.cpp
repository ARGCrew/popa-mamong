...
HXLINE( 618)		 ::flixel::_hx_system::frontEnds::InputFrontEnd _hx_tmp2 = ::flixel::FlxG_obj::inputs;
HXDLIN( 618)		::flixel::FlxG_obj::touches = _hx_tmp2->add_flixel_input_touch_FlxTouchManager( ::flixel::input::touch::FlxTouchManager_obj::__alloc( HX_CTX ));
HXLINE( 622)		 ::flixel::_hx_system::frontEnds::InputFrontEnd _hx_tmp3 = ::flixel::FlxG_obj::inputs;
HXDLIN( 622)		::flixel::FlxG_obj::gamepads = _hx_tmp3->add_flixel_input_gamepad_FlxGamepadManager( ::flixel::input::gamepad::FlxGamepadManager_obj::__alloc( HX_CTX ));
