...
HXLINE( 507)				::flixel::FlxG_obj::log->advanced((((HX_("frameWidth:",81,5b,44,2a) + frameWidth) + HX_(" is larger than the graphic's width:",7b,c4,23,c9)) + graph->width),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            			}
            		}
...
HXLINE( 515)				::flixel::FlxG_obj::log->advanced((((HX_("frameHeight:",c6,a1,c5,a0) + frameHeight) + HX_(" is larger than the graphic's height:",8c,13,62,05)) + graph->height),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            			}
            		}
...
HXLINE( 800)				::flixel::FlxBasic_obj::visibleCount++;
            			}
            		}
HXLINE( 805)		if (::flixel::FlxG_obj::debugger->drawDebug) {
HXLINE( 806)			this->drawDebug();
            		}
            	}
