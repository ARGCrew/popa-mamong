...
HX_LOCAL_STACK_FRAME(_hx_pos_85f0573c4a29b283_132_makeSprite,"flixel.addons.transition.TransitionFade","makeSprite",0x080a6440,"flixel.addons.transition.TransitionFade.makeSprite","flixel/addons/transition/TransitionFade.hx",132,0x307a6abc)
HX_LOCAL_STACK_FRAME(_hx_pos_85f0573c4a29b283_175_getGradient,"flixel.addons.transition.TransitionFade","getGradient",0xadab8059,"flixel.addons.transition.TransitionFade.getGradient","flixel/addons/transition/TransitionFade.hx",175,0x307a6abc)
HX_LOCAL_STACK_FRAME(_hx_pos_85f0573c4a29b283_203_finishTween,"flixel.addons.transition.TransitionFade","finishTween",0x9dee50cb,"flixel.addons.transition.TransitionFade.finishTween","flixel/addons/transition/TransitionFade.hx",203,0x307a6abc)
...
HX_DEFINE_DYNAMIC_FUNC5(TransitionFade_obj,setTweenValues,(void))
 ...
 ::flixel::FlxSprite TransitionFade_obj::makeSprite(Float dirX,Float dirY, ::flixel::math::FlxRect region){
            	HX_GC_STACKFRAME(&_hx_pos_85f0573c4a29b283_132_makeSprite)
HXLINE( 133)		 ::flixel::FlxSprite sprite =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,region->x,region->y,null());
HXLINE( 135)		bool _hx_tmp;
HXDLIN( 135)		if ((dirX == 0)) {
HXLINE( 135)			_hx_tmp = (dirY == 0);
            		}
            		else {
HXLINE( 135)			_hx_tmp = false;
            		}
HXDLIN( 135)		if (_hx_tmp) {
HXLINE( 138)			int _hx_tmp1 = ::Std_obj::_hx_int(region->width);
HXDLIN( 138)			int _hx_tmp2 = ::Std_obj::_hx_int(region->height);
HXDLIN( 138)			sprite->makeGraphic(_hx_tmp1,_hx_tmp2,this->_data->color,null(),null());
            		}
            		else {
HXLINE( 140)			bool _hx_tmp3;
HXDLIN( 140)			if ((dirX == 0)) {
HXLINE( 140)				_hx_tmp3 = (dirY != 0);
            			}
            			else {
HXLINE( 140)				_hx_tmp3 = false;
            			}
HXDLIN( 140)			if (_hx_tmp3) {
HXLINE( 143)				int _hx_tmp4 = ::Std_obj::_hx_int((region->height * ( (Float)(2) )));
HXDLIN( 143)				sprite->makeGraphic(1,_hx_tmp4,this->_data->color,null(),null());
HXLINE( 144)				int angle;
HXDLIN( 144)				if ((dirY > 0)) {
HXLINE( 144)					angle = 90;
            				}
            				else {
HXLINE( 144)					angle = 270;
            				}
HXLINE( 145)				int gradient = ::Std_obj::_hx_int(region->height);
HXDLIN( 145)				 ::openfl::display::BitmapData gradient1 = ::flixel::util::FlxGradient_obj::createGradientBitmapData(1,gradient,::Array_obj< int >::__new(2)->init(0,this->_data->color)->init(1,0),1,angle,null());
HXLINE( 146)				Float destY;
HXDLIN( 146)				if ((dirY > 0)) {
HXLINE( 146)					destY = region->height;
            				}
            				else {
HXLINE( 146)					destY = ( (Float)(0) );
            				}
HXLINE( 147)				 ::openfl::display::BitmapData _hx_tmp5 = sprite->get_pixels();
HXDLIN( 147)				 ::openfl::geom::Rectangle gradient2 = gradient1->rect;
HXDLIN( 147)				_hx_tmp5->copyPixels(gradient1,gradient2, ::openfl::geom::Point_obj::__alloc( HX_CTX ,0,destY),null(),null(),null());
HXLINE( 148)				{
HXLINE( 148)					 ::flixel::math::FlxBasePoint this1 = sprite->scale;
HXDLIN( 148)					this1->set_x(region->width);
HXDLIN( 148)					this1->set_y(((Float)1.0));
            				}
HXLINE( 149)				sprite->updateHitbox();
            			}
            			else {
HXLINE( 151)				bool _hx_tmp6;
HXDLIN( 151)				if ((dirX != 0)) {
HXLINE( 151)					_hx_tmp6 = (dirY == 0);
            				}
            				else {
HXLINE( 151)					_hx_tmp6 = false;
            				}
HXDLIN( 151)				if (_hx_tmp6) {
HXLINE( 154)					Float destX;
HXDLIN( 154)					if ((dirX > 0)) {
HXLINE( 154)						destX = region->width;
            					}
            					else {
HXLINE( 154)						destX = ( (Float)(0) );
            					}
HXLINE( 155)					int angle1;
HXDLIN( 155)					if ((dirX > 0)) {
HXLINE( 155)						angle1 = 0;
            					}
            					else {
HXLINE( 155)						angle1 = 180;
            					}
HXLINE( 156)					int _hx_tmp7 = ::Std_obj::_hx_int((region->width * ( (Float)(2) )));
HXDLIN( 156)					sprite->makeGraphic(_hx_tmp7,1,this->_data->color,null(),null());
HXLINE( 157)					int gradient3 = ::Std_obj::_hx_int(region->width);
HXDLIN( 157)					 ::openfl::display::BitmapData gradient4 = ::flixel::util::FlxGradient_obj::createGradientBitmapData(gradient3,1,::Array_obj< int >::__new(2)->init(0,this->_data->color)->init(1,0),1,angle1,null());
HXLINE( 158)					 ::openfl::display::BitmapData _hx_tmp8 = sprite->get_pixels();
HXDLIN( 158)					 ::openfl::geom::Rectangle gradient5 = gradient4->rect;
HXDLIN( 158)					_hx_tmp8->copyPixels(gradient4,gradient5, ::openfl::geom::Point_obj::__alloc( HX_CTX ,destX,0),null(),null(),null());
HXLINE( 159)					{
HXLINE( 159)						 ::flixel::math::FlxBasePoint this2 = sprite->scale;
HXDLIN( 159)						Float y = region->height;
HXDLIN( 159)						this2->set_x(((Float)1.0));
HXDLIN( 159)						this2->set_y(y);
            					}
HXLINE( 160)					sprite->updateHitbox();
            				}
            				else {
HXLINE( 162)					bool _hx_tmp9;
HXDLIN( 162)					if ((dirX != 0)) {
HXLINE( 162)						_hx_tmp9 = (dirY != 0);
            					}
            					else {
HXLINE( 162)						_hx_tmp9 = false;
            					}
HXDLIN( 162)					if (_hx_tmp9) {
HXLINE( 165)						sprite->loadGraphic(this->getGradient(),null(),null(),null(),null(),null());
HXLINE( 166)						sprite->set_color(this->_data->color);
HXLINE( 167)						sprite->set_flipX((dirX < 0));
HXLINE( 168)						sprite->set_flipY((dirY < 0));
            					}
            				}
            			}
            		}
HXLINE( 171)		return sprite;
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(TransitionFade_obj,makeSprite,return )
 ...
 ::flixel::graphics::FlxGraphic TransitionFade_obj::getGradient(){
            	HX_GC_STACKFRAME(&_hx_pos_85f0573c4a29b283_175_getGradient)
HXLINE( 177)		int gameWidth = ::flixel::FlxG_obj::width;
HXLINE( 178)		int gameHeight = ::flixel::FlxG_obj::height;
HXLINE( 179)		 ::openfl::display::BitmapData source = ::flixel::FlxG_obj::bitmap->add(HX_("flixel/images/transitions/diagonal_gradient.png",20,34,41,22),null(),null())->bitmap;
HXLINE( 180)		::String key = ((((HX_("flixel/images/transitions/diagonal_gradient.png",20,34,41,22) + HX_(":",3a,00,00,00)) + gameWidth) + HX_("x",78,00,00,00)) + gameHeight);
HXLINE( 182)		 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
HXLINE( 183)		if (::hx::IsNull( graphic )) {
HXLINE( 185)			 ::openfl::display::BitmapData gradient =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,::Math_obj::floor((( (Float)(gameWidth) ) * ((Float)2.5))),gameHeight,true,0);
HXLINE( 188)			 ::openfl::geom::Matrix matrix =  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
HXLINE( 189)			matrix->scale((( (Float)(gradient->width) ) / ( (Float)(source->width) )),(( (Float)(gradient->height) ) / ( (Float)(source->height) )));
HXLINE( 190)			gradient->draw(source,matrix,null(),null(),null(),true);
HXLINE( 193)			graphic = ::flixel::FlxG_obj::bitmap->add(gradient,false,key);
HXLINE( 194)			graphic->persist = true;
HXLINE( 195)			graphic->set_destroyOnNoUse(false);
            		}
HXLINE( 198)		return graphic;
            	}
...
void TransitionFade_obj::finishTween( ::flixel::tweens::FlxTween f){
            	HX_STACKFRAME(&_hx_pos_85f0573c4a29b283_203_finishTween)
HXDLIN( 203)		this->delayThenFinish();
            	}
