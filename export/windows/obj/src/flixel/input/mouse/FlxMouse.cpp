...
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_391_destroy,"flixel.input.mouse.FlxMouse","destroy",0x77a13b9e,"flixel.input.mouse.FlxMouse.destroy","flixel/input/mouse/FlxMouse.hx",391,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_430_reset,"flixel.input.mouse.FlxMouse","reset",0xe595a773,"flixel.input.mouse.FlxMouse.reset","flixel/input/mouse/FlxMouse.hx",430,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_479_update,"flixel.input.mouse.FlxMouse","update",0x7bea17e5,"flixel.input.mouse.FlxMouse.update","flixel/input/mouse/FlxMouse.hx",479,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_515_onFocus,"flixel.input.mouse.FlxMouse","onFocus",0xede20cdd,"flixel.input.mouse.FlxMouse.onFocus","flixel/input/mouse/FlxMouse.hx",515,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_529_onFocusLost,"flixel.input.mouse.FlxMouse","onFocusLost",0xc7f71561,"flixel.input.mouse.FlxMouse.onFocusLost","flixel/input/mouse/FlxMouse.hx",529,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_546_onGameStart,"flixel.input.mouse.FlxMouse","onGameStart",0x61da7695,"flixel.input.mouse.FlxMouse.onGameStart","flixel/input/mouse/FlxMouse.hx",546,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_554_onMouseWheel,"flixel.input.mouse.FlxMouse","onMouseWheel",0xdc642911,"flixel.input.mouse.FlxMouse.onMouseWheel","flixel/input/mouse/FlxMouse.hx",554,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_567_onMouseLeave,"flixel.input.mouse.FlxMouse","onMouseLeave",0x84fd296d,"flixel.input.mouse.FlxMouse.onMouseLeave","flixel/input/mouse/FlxMouse.hx",567,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_574_get_justMoved,"flixel.input.mouse.FlxMouse","get_justMoved",0xd61e87e2,"flixel.input.mouse.FlxMouse.get_justMoved","flixel/input/mouse/FlxMouse.hx",574,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_577_get_deltaX,"flixel.input.mouse.FlxMouse","get_deltaX",0x58943105,"flixel.input.mouse.FlxMouse.get_deltaX","flixel/input/mouse/FlxMouse.hx",577,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_580_get_deltaY,"flixel.input.mouse.FlxMouse","get_deltaY",0x58943106,"flixel.input.mouse.FlxMouse.get_deltaY","flixel/input/mouse/FlxMouse.hx",580,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_583_get_deltaScreenX,"flixel.input.mouse.FlxMouse","get_deltaScreenX",0x17615bb9,"flixel.input.mouse.FlxMouse.get_deltaScreenX","flixel/input/mouse/FlxMouse.hx",583,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_586_get_deltaScreenY,"flixel.input.mouse.FlxMouse","get_deltaScreenY",0x17615bba,"flixel.input.mouse.FlxMouse.get_deltaScreenY","flixel/input/mouse/FlxMouse.hx",586,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_589_get_pressed,"flixel.input.mouse.FlxMouse","get_pressed",0x4652635d,"flixel.input.mouse.FlxMouse.get_pressed","flixel/input/mouse/FlxMouse.hx",589,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_592_get_justPressed,"flixel.input.mouse.FlxMouse","get_justPressed",0x70091811,"flixel.input.mouse.FlxMouse.get_justPressed","flixel/input/mouse/FlxMouse.hx",592,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_595_get_released,"flixel.input.mouse.FlxMouse","get_released",0x489a9ba2,"flixel.input.mouse.FlxMouse.get_released","flixel/input/mouse/FlxMouse.hx",595,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_598_get_justReleased,"flixel.input.mouse.FlxMouse","get_justReleased",0x9ec2046e,"flixel.input.mouse.FlxMouse.get_justReleased","flixel/input/mouse/FlxMouse.hx",598,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_601_get_justPressedTimeInTicks,"flixel.input.mouse.FlxMouse","get_justPressedTimeInTicks",0xbe077333,"flixel.input.mouse.FlxMouse.get_justPressedTimeInTicks","flixel/input/mouse/FlxMouse.hx",601,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_605_get_pressedRight,"flixel.input.mouse.FlxMouse","get_pressedRight",0x90e8c73f,"flixel.input.mouse.FlxMouse.get_pressedRight","flixel/input/mouse/FlxMouse.hx",605,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_608_get_justPressedRight,"flixel.input.mouse.FlxMouse","get_justPressedRight",0xa8a2860b,"flixel.input.mouse.FlxMouse.get_justPressedRight","flixel/input/mouse/FlxMouse.hx",608,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_611_get_releasedRight,"flixel.input.mouse.FlxMouse","get_releasedRight",0xdc7574da,"flixel.input.mouse.FlxMouse.get_releasedRight","flixel/input/mouse/FlxMouse.hx",611,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_614_get_justReleasedRight,"flixel.input.mouse.FlxMouse","get_justReleasedRight",0x8742a88e,"flixel.input.mouse.FlxMouse.get_justReleasedRight","flixel/input/mouse/FlxMouse.hx",614,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_617_get_justPressedTimeInTicksRight,"flixel.input.mouse.FlxMouse","get_justPressedTimeInTicksRight",0xf3dc8fa9,"flixel.input.mouse.FlxMouse.get_justPressedTimeInTicksRight","flixel/input/mouse/FlxMouse.hx",617,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_620_get_pressedMiddle,"flixel.input.mouse.FlxMouse","get_pressedMiddle",0x38fe0e92,"flixel.input.mouse.FlxMouse.get_pressedMiddle","flixel/input/mouse/FlxMouse.hx",620,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_623_get_justPressedMiddle,"flixel.input.mouse.FlxMouse","get_justPressedMiddle",0xe3cb4246,"flixel.input.mouse.FlxMouse.get_justPressedMiddle","flixel/input/mouse/FlxMouse.hx",623,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_626_get_releasedMiddle,"flixel.input.mouse.FlxMouse","get_releasedMiddle",0x08894897,"flixel.input.mouse.FlxMouse.get_releasedMiddle","flixel/input/mouse/FlxMouse.hx",626,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_629_get_justReleasedMiddle,"flixel.input.mouse.FlxMouse","get_justReleasedMiddle",0xd1495263,"flixel.input.mouse.FlxMouse.get_justReleasedMiddle","flixel/input/mouse/FlxMouse.hx",629,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_632_get_justPressedTimeInTicksMiddle,"flixel.input.mouse.FlxMouse","get_justPressedTimeInTicksMiddle",0x6b59a2e8,"flixel.input.mouse.FlxMouse.get_justPressedTimeInTicksMiddle","flixel/input/mouse/FlxMouse.hx",632,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_636_showSystemCursor,"flixel.input.mouse.FlxMouse","showSystemCursor",0xf4551c9e,"flixel.input.mouse.FlxMouse.showSystemCursor","flixel/input/mouse/FlxMouse.hx",636,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_647_hideSystemCursor,"flixel.input.mouse.FlxMouse","hideSystemCursor",0xb5438fe3,"flixel.input.mouse.FlxMouse.hideSystemCursor","flixel/input/mouse/FlxMouse.hx",647,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_664_set_useSystemCursor,"flixel.input.mouse.FlxMouse","set_useSystemCursor",0x074e74d3,"flixel.input.mouse.FlxMouse.set_useSystemCursor","flixel/input/mouse/FlxMouse.hx",664,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_678_showCursor,"flixel.input.mouse.FlxMouse","showCursor",0xa585e38f,"flixel.input.mouse.FlxMouse.showCursor","flixel/input/mouse/FlxMouse.hx",678,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_697_hideCursor,"flixel.input.mouse.FlxMouse","hideCursor",0xd396e514,"flixel.input.mouse.FlxMouse.hideCursor","flixel/input/mouse/FlxMouse.hx",697,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_703_set_visible,"flixel.input.mouse.FlxMouse","set_visible",0xb9fd1039,"flixel.input.mouse.FlxMouse.set_visible","flixel/input/mouse/FlxMouse.hx",703,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_714_record,"flixel.input.mouse.FlxMouse","record",0xf2d1086d,"flixel.input.mouse.FlxMouse.record","flixel/input/mouse/FlxMouse.hx",714,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_732_playback,"flixel.input.mouse.FlxMouse","playback",0xaadcd2f7,"flixel.input.mouse.FlxMouse.playback","flixel/input/mouse/FlxMouse.hx",732,0xe4e80b89)
namespace flixel{
namespace input{
namespace mouse{
...
HXLINE( 445)		super::__construct();
HXLINE( 446)		this->cursorContainer = cursorContainer;
HXLINE( 447)		this->cursorContainer->mouseChildren = false;
HXLINE( 448)		this->cursorContainer->mouseEnabled = false;
HXLINE( 450)		this->_leftButton =  ::flixel::input::mouse::FlxMouseButton_obj::__alloc( HX_CTX ,-1);
HXLINE( 452)		this->_stage = ::openfl::Lib_obj::get_current()->stage;
HXLINE( 453)		this->_stage->addEventListener(HX_("mouseDown",27,b1,c2,ee),this->_leftButton->onDown_dyn(),null(),null(),null());
HXLINE( 454)		this->_stage->addEventListener(HX_("mouseUp",e0,f3,72,c0),this->_leftButton->onUp_dyn(),null(),null(),null());
HXLINE( 457)		this->_middleButton =  ::flixel::input::mouse::FlxMouseButton_obj::__alloc( HX_CTX ,-2);
HXLINE( 458)		this->_rightButton =  ::flixel::input::mouse::FlxMouseButton_obj::__alloc( HX_CTX ,-3);
HXLINE( 460)		this->_stage->addEventListener(HX_("middleMouseDown",12,2b,fe,01),this->_middleButton->onDown_dyn(),null(),null(),null());
HXLINE( 461)		this->_stage->addEventListener(HX_("middleMouseUp",0b,8d,f5,3a),this->_middleButton->onUp_dyn(),null(),null(),null());
HXLINE( 462)		this->_stage->addEventListener(HX_("rightMouseDown",ab,29,d7,cd),this->_rightButton->onDown_dyn(),null(),null(),null());
HXLINE( 463)		this->_stage->addEventListener(HX_("rightMouseUp",64,83,21,ab),this->_rightButton->onUp_dyn(),null(),null(),null());
HXLINE( 465)		this->_stage->addEventListener(HX_("mouseLeave",92,28,20,90),this->onMouseLeave_dyn(),null(),null(),null());
HXLINE( 468)		this->_stage->addEventListener(HX_("mouseWheel",36,28,87,e7),this->onMouseWheel_dyn(),null(),null(),null());
HXLINE( 470)		::flixel::FlxG_obj::signals->postGameStart->add(this->onGameStart_dyn());
HXLINE( 471)		::openfl::ui::Mouse_obj::hide();
            	}
...
void FlxMouse_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_391_destroy)
HXLINE( 392)		if (::hx::IsNotNull( this->_stage )) {
HXLINE( 394)			this->_stage->removeEventListener(HX_("mouseDown",27,b1,c2,ee),this->_leftButton->onDown_dyn(),null());
HXLINE( 395)			this->_stage->removeEventListener(HX_("mouseUp",e0,f3,72,c0),this->_leftButton->onUp_dyn(),null());
HXLINE( 398)			this->_stage->removeEventListener(HX_("middleMouseDown",12,2b,fe,01),this->_middleButton->onDown_dyn(),null());
HXLINE( 399)			this->_stage->removeEventListener(HX_("middleMouseUp",0b,8d,f5,3a),this->_middleButton->onUp_dyn(),null());
HXLINE( 400)			this->_stage->removeEventListener(HX_("rightMouseDown",ab,29,d7,cd),this->_rightButton->onDown_dyn(),null());
HXLINE( 401)			this->_stage->removeEventListener(HX_("rightMouseUp",64,83,21,ab),this->_rightButton->onUp_dyn(),null());
HXLINE( 403)			this->_stage->removeEventListener(HX_("mouseLeave",92,28,20,90),this->onMouseLeave_dyn(),null());
HXLINE( 406)			this->_stage->removeEventListener(HX_("mouseWheel",36,28,87,e7),this->onMouseWheel_dyn(),null());
            		}
HXLINE( 409)		this->cursorContainer = null();
HXLINE( 410)		this->_cursor = null();
HXLINE( 416)		this->_leftButton = ( ( ::flixel::input::mouse::FlxMouseButton)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_leftButton)) );
HXLINE( 418)		this->_middleButton = ( ( ::flixel::input::mouse::FlxMouseButton)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_middleButton)) );
HXLINE( 419)		this->_rightButton = ( ( ::flixel::input::mouse::FlxMouseButton)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_rightButton)) );
HXLINE( 422)		this->_cursorBitmapData = ::flixel::util::FlxDestroyUtil_obj::dispose(this->_cursorBitmapData);
HXLINE( 423)		::flixel::FlxG_obj::signals->postGameStart->remove(this->onGameStart_dyn());
            	}
...
void FlxMouse_obj::reset(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_430_reset)
HXLINE( 431)		this->_leftButton->reset();
HXLINE( 434)		this->_middleButton->reset();
HXLINE( 435)		this->_rightButton->reset();
            	}
...
void FlxMouse_obj::update(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_479_update)
HXLINE( 480)		this->_prevX = this->x;
HXLINE( 481)		this->_prevY = this->y;
HXLINE( 482)		this->_prevScreenX = this->screenX;
HXLINE( 483)		this->_prevScreenY = this->screenY;
HXLINE( 486)		{
HXLINE( 486)			Float newX = ::flixel::FlxG_obj::game->get_mouseX();
HXDLIN( 486)			Float newY = ::flixel::FlxG_obj::game->get_mouseY();
HXDLIN( 486)			this->_globalScreenX = ::Std_obj::_hx_int((newX / ::flixel::FlxG_obj::scaleMode->scale->x));
HXDLIN( 486)			this->_globalScreenY = ::Std_obj::_hx_int((newY / ::flixel::FlxG_obj::scaleMode->scale->y));
HXDLIN( 486)			this->updatePositions();
            		}
HXLINE( 489)		if (this->visible) {
HXLINE( 491)			 ::openfl::display::Sprite _hx_tmp = this->cursorContainer;
HXDLIN( 491)			_hx_tmp->set_x(::flixel::FlxG_obj::game->get_mouseX());
HXLINE( 492)			 ::openfl::display::Sprite _hx_tmp1 = this->cursorContainer;
HXDLIN( 492)			_hx_tmp1->set_y(::flixel::FlxG_obj::game->get_mouseY());
            		}
HXLINE( 497)		this->_leftButton->update();
HXLINE( 499)		this->_middleButton->update();
HXLINE( 500)		this->_rightButton->update();
HXLINE( 504)		if (!(this->_wheelUsed)) {
HXLINE( 506)			this->wheel = 0;
            		}
HXLINE( 508)		this->_wheelUsed = false;
            	}
...
void FlxMouse_obj::onFocus(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_515_onFocus)
HXLINE( 516)		this->reset();
HXLINE( 519)		this->set_useSystemCursor(this->useSystemCursor);
HXLINE( 521)		this->set_visible(this->_visibleWhenFocusLost);
            	}
...
void FlxMouse_obj::onFocusLost(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_529_onFocusLost)
HXLINE( 531)		this->_visibleWhenFocusLost = this->visible;
HXLINE( 533)		if (this->visible) {
HXLINE( 535)			this->set_visible(false);
            		}
HXLINE( 538)		::openfl::ui::Mouse_obj::show();
            	}
...
void FlxMouse_obj::onGameStart(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_546_onGameStart)
HXDLIN( 546)		this->set_visible(this->visible);
            	}
...
void FlxMouse_obj::onMouseWheel( ::openfl::events::MouseEvent flashEvent){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_554_onMouseWheel)
HXDLIN( 554)		if (this->enabled) {
HXLINE( 556)			this->_wheelUsed = true;
HXLINE( 557)			this->wheel = flashEvent->delta;
            		}
            	}
...
void FlxMouse_obj::onMouseLeave( ::openfl::events::Event _){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_567_onMouseLeave)
HXLINE( 568)		this->_rightButton->onUp(null());
HXLINE( 569)		this->_middleButton->onUp(null());
            	}
...
bool FlxMouse_obj::get_justMoved(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_574_get_justMoved)
HXDLIN( 574)		if ((this->_prevX == this->x)) {
HXDLIN( 574)			return (this->_prevY != this->y);
            		}
            		else {
...
int FlxMouse_obj::get_deltaX(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_577_get_deltaX)
HXDLIN( 577)		return (this->x - this->_prevX);
            	}
...
int FlxMouse_obj::get_deltaY(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_580_get_deltaY)
HXDLIN( 580)		return (this->y - this->_prevY);
            	}
...
int FlxMouse_obj::get_deltaScreenX(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_583_get_deltaScreenX)
HXDLIN( 583)		return (this->screenX - this->_prevScreenX);
            	}
...
int FlxMouse_obj::get_deltaScreenY(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_586_get_deltaScreenY)
HXDLIN( 586)		return (this->screenY - this->_prevScreenY);
            	}
...
bool FlxMouse_obj::get_pressed(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_589_get_pressed)
HXDLIN( 589)		 ::flixel::input::mouse::FlxMouseButton _this = this->_leftButton;
HXDLIN( 589)		if ((_this->current != 1)) {
HXDLIN( 589)			return (_this->current == 2);
            		}
            		else {
HXDLIN( 589)			return true;
            		}
...
bool FlxMouse_obj::get_justPressed(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_592_get_justPressed)
HXDLIN( 592)		return (this->_leftButton->current == 2);
            	}
...
bool FlxMouse_obj::get_released(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_595_get_released)
HXDLIN( 595)		 ::flixel::input::mouse::FlxMouseButton _this = this->_leftButton;
HXDLIN( 595)		if ((_this->current != 0)) {
HXDLIN( 595)			return (_this->current == -1);
            		}
            		else {
...
bool FlxMouse_obj::get_justReleased(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_598_get_justReleased)
HXDLIN( 598)		return (this->_leftButton->current == -1);
            	}
...
int FlxMouse_obj::get_justPressedTimeInTicks(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_601_get_justPressedTimeInTicks)
HXDLIN( 601)		return this->_leftButton->justPressedTimeInTicks;
            	}
...
bool FlxMouse_obj::get_pressedRight(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_605_get_pressedRight)
HXDLIN( 605)		 ::flixel::input::mouse::FlxMouseButton _this = this->_rightButton;
HXDLIN( 605)		if ((_this->current != 1)) {
HXDLIN( 605)			return (_this->current == 2);
            		}
            		else {
HXDLIN( 605)			return true;
            		}
...
bool FlxMouse_obj::get_justPressedRight(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_608_get_justPressedRight)
HXDLIN( 608)		return (this->_rightButton->current == 2);
            	}
...
bool FlxMouse_obj::get_releasedRight(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_611_get_releasedRight)
HXDLIN( 611)		 ::flixel::input::mouse::FlxMouseButton _this = this->_rightButton;
HXDLIN( 611)		if ((_this->current != 0)) {
HXDLIN( 611)			return (_this->current == -1);
            		}
            		else {
HXDLIN( 611)			return true;
            		}
...
bool FlxMouse_obj::get_justReleasedRight(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_614_get_justReleasedRight)
HXDLIN( 614)		return (this->_rightButton->current == -1);
            	}
...
int FlxMouse_obj::get_justPressedTimeInTicksRight(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_617_get_justPressedTimeInTicksRight)
HXDLIN( 617)		return this->_rightButton->justPressedTimeInTicks;
            	}
...
bool FlxMouse_obj::get_pressedMiddle(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_620_get_pressedMiddle)
HXDLIN( 620)		 ::flixel::input::mouse::FlxMouseButton _this = this->_middleButton;
HXDLIN( 620)		if ((_this->current != 1)) {
HXDLIN( 620)			return (_this->current == 2);
            		}
            		else {
HXDLIN( 620)			return true;
            		}
...
bool FlxMouse_obj::get_justPressedMiddle(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_623_get_justPressedMiddle)
HXDLIN( 623)		return (this->_middleButton->current == 2);
            	}
...
bool FlxMouse_obj::get_releasedMiddle(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_626_get_releasedMiddle)
HXDLIN( 626)		 ::flixel::input::mouse::FlxMouseButton _this = this->_middleButton;
HXDLIN( 626)		if ((_this->current != 0)) {
HXDLIN( 626)			return (_this->current == -1);
            		}
            		else {
...
bool FlxMouse_obj::get_justReleasedMiddle(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_629_get_justReleasedMiddle)
HXDLIN( 629)		return (this->_middleButton->current == -1);
            	}
...
int FlxMouse_obj::get_justPressedTimeInTicksMiddle(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_632_get_justPressedTimeInTicksMiddle)
HXDLIN( 632)		return this->_middleButton->justPressedTimeInTicks;
            	}
...
void FlxMouse_obj::showSystemCursor(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_636_showSystemCursor)
HXLINE( 640)		this->cursorContainer->set_visible(false);
HXLINE( 643)		::openfl::ui::Mouse_obj::show();
            	}
...
void FlxMouse_obj::hideSystemCursor(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_647_hideSystemCursor)
HXLINE( 654)		::openfl::ui::Mouse_obj::hide();
HXLINE( 656)		if (this->visible) {
HXLINE( 658)			this->cursorContainer->set_visible(true);
            		}
            	}
...
bool FlxMouse_obj::set_useSystemCursor(bool value){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_664_set_useSystemCursor)
HXLINE( 665)		if (value) {
HXLINE( 667)			this->showSystemCursor();
            		}
            		else {
HXLINE( 671)			this->hideSystemCursor();
            		}
HXLINE( 673)		return (this->useSystemCursor = value);
            	}
...
void FlxMouse_obj::showCursor(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_678_showCursor)
HXDLIN( 678)		if (this->useSystemCursor) {
HXLINE( 680)			::openfl::ui::Mouse_obj::show();
            		}
            		else {
HXLINE( 684)			if (::hx::IsNull( this->_cursor )) {
HXLINE( 685)				this->load(null(),null(),null(),null());
            			}
HXLINE( 690)			this->cursorContainer->set_visible(true);
HXLINE( 691)			::openfl::ui::Mouse_obj::hide();
            		}
            	}
...
void FlxMouse_obj::hideCursor(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_697_hideCursor)
HXLINE( 698)		this->cursorContainer->set_visible(false);
HXLINE( 699)		::openfl::ui::Mouse_obj::hide();
            	}
...
bool FlxMouse_obj::set_visible(bool value){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_703_set_visible)
HXLINE( 704)		if (value) {
HXLINE( 705)			this->showCursor();
            		}
            		else {
HXLINE( 707)			this->hideCursor();
            		}
HXLINE( 709)		return (this->visible = value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxMouse_obj,set_visible,return )
 ...
 ::flixel::_hx_system::replay::MouseRecord FlxMouse_obj::record(){
            	HX_GC_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_714_record)
HXLINE( 715)		bool _hx_tmp;
HXDLIN( 715)		bool _hx_tmp1;
HXDLIN( 715)		bool _hx_tmp2;
HXDLIN( 715)		if ((this->_lastX == this->_globalScreenX)) {
HXLINE( 715)			_hx_tmp2 = (this->_lastY == this->_globalScreenY);
            		}
            		else {
HXLINE( 715)			_hx_tmp2 = false;
            		}
HXDLIN( 715)		if (_hx_tmp2) {
HXLINE( 715)			_hx_tmp1 = (this->_lastLeftButtonState == this->_leftButton->current);
            		}
            		else {
HXLINE( 715)			_hx_tmp1 = false;
            		}
HXDLIN( 715)		if (_hx_tmp1) {
HXLINE( 715)			_hx_tmp = (this->_lastWheel == this->wheel);
            		}
            		else {
...
HXLINE( 723)		this->_lastX = this->_globalScreenX;
HXLINE( 724)		this->_lastY = this->_globalScreenY;
HXLINE( 725)		this->_lastLeftButtonState = this->_leftButton->current;
HXLINE( 726)		this->_lastWheel = this->wheel;
HXLINE( 727)		return  ::flixel::_hx_system::replay::MouseRecord_obj::__alloc( HX_CTX ,this->_lastX,this->_lastY,this->_leftButton->current,this->_lastWheel);
            	}
...
void FlxMouse_obj::playback( ::flixel::_hx_system::replay::MouseRecord record){
            	HX_GC_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_732_playback)
HXLINE( 736)		bool _hx_tmp;
HXDLIN( 736)		bool _hx_tmp1;
HXDLIN( 736)		if ((this->_lastLeftButtonState != 1)) {
HXLINE( 736)			_hx_tmp1 = (this->_lastLeftButtonState == 2);
            		}
            		else {
HXLINE( 736)			_hx_tmp1 = true;
            		}
HXDLIN( 736)		if (_hx_tmp1) {
HXLINE( 737)			if ((record->button != 0)) {
HXLINE( 736)				_hx_tmp = (record->button == -1);
            			}
            			else {
...
HXLINE( 739)			 ::openfl::display::Stage _hx_tmp2 = this->_stage;
HXDLIN( 739)			_hx_tmp2->dispatchEvent( ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,HX_("mouseUp",e0,f3,72,c0),true,false,record->x,record->y,null(),null(),null(),null(),null(),null(),null(),null(),null()));
            		}
HXLINE( 741)		this->_lastLeftButtonState = (this->_leftButton->current = record->button);
HXLINE( 742)		this->wheel = record->wheel;
HXLINE( 743)		this->_globalScreenX = record->x;
HXLINE( 744)		this->_globalScreenY = record->y;
HXLINE( 745)		this->updatePositions();
            	}
