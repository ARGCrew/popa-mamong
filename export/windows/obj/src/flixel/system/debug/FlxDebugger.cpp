...
HXDLIN( 511)		::String prefix = HX_("",00,00,00,00);
HXDLIN( 511)		if (!( ::EReg_obj::__alloc( HX_CTX ,HX_("^https?://",48,ee,dd,38),HX_("",00,00,00,00))->match(HX_("http://www.haxeflixel.com",de,bc,02,e0)))) {
HXDLIN( 511)			prefix = HX_("http://",52,75,cd,5a);
            		}
HXDLIN( 511)		::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,(prefix + HX_("http://www.haxeflixel.com",de,bc,02,e0))),HX_("_blank",95,26,d9,b0));
            	}
...
HXLINE( 521)		{
HXLINE( 521)			::String prefix = HX_("",00,00,00,00);
HXDLIN( 521)			if (!( ::EReg_obj::__alloc( HX_CTX ,HX_("^https?://",48,ee,dd,38),HX_("",00,00,00,00))->match(url))) {
HXLINE( 521)				prefix = HX_("http://",52,75,cd,5a);
            			}
HXDLIN( 521)			::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,(prefix + url)),HX_("_blank",95,26,d9,b0));
            		}
            	}
