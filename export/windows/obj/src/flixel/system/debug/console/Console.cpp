...
HX_LOCAL_STACK_FRAME(_hx_pos_c69022abc8c5c26b_297_registerObject,"flixel.system.debug.console.Console","registerObject",0x0bbfe598,"flixel.system.debug.console.Console.registerObject","flixel/system/debug/console/Console.hx",297,0x367943c8)
...
HXLINE( 100)		this->input->set_text(HX_("Using the console requires hscript - please run 'haxelib install hscript'.",1a,91,ca,5f));
...
HXLINE( 127)		this->input->addEventListener(HX_("mouseDown",27,b1,c2,ee), ::Dynamic(new _hx_Closure_0(_gthis)),null(),null(),null());
HXLINE( 131)		::openfl::Lib_obj::get_current()->stage->addEventListener(HX_("mouseDown",27,b1,c2,ee), ::Dynamic(new _hx_Closure_1(_gthis)),null(),null(),null());
            	}
...
HXLINE( 169)		if ((this->input->get_text() == HX_("Using the console requires hscript - please run 'haxelib install hscript'.",1a,91,ca,5f))) {
...
HXLINE( 188)			this->input->set_text(HX_("Using the console requires hscript - please run 'haxelib install hscript'.",1a,91,ca,5f));
            		}
...
void Console_obj::registerObject(::String objectAlias, ::Dynamic anyObject){
            	HX_STACKFRAME(&_hx_pos_c69022abc8c5c26b_297_registerObject)
HXDLIN( 297)		this->registeredObjects->set(objectAlias,anyObject);
            	}
...
HXDLIN(  34)		DEFAULT_TEXT = HX_("Using the console requires hscript - please run 'haxelib install hscript'.",1a,91,ca,5f);
            	}
}
