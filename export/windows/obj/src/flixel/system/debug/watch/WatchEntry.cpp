...
HXDLIN(  60)				::String _g5 = _g->_hx_getString(1);
...
HXLINE(  99)					::String _g1 = _g->_hx_getString(0);
            				...
            				break;
            				case (int)2: {
HXLINE(  97)					::String _g2 = _g->_hx_getString(1);
HXDLIN(  97)					{
...
HXDLIN( 117)				::String parsedExpr = _g->_hx_getString(1);
HXLINE( 121)				return HX_("hscript is not installed",84,84,f9,28);
            			}
            			break;
            			case (int)3: {
