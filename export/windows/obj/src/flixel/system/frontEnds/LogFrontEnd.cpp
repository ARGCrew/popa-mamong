...
HX_LOCAL_STACK_FRAME(_hx_pos_ba09e0c9e62cea6b_108_clear,"flixel.system.frontEnds.LogFrontEnd","clear",0x4a0034fb,"flixel.system.frontEnds.LogFrontEnd.clear","flixel/system/frontEnds/LogFrontEnd.hx",108,0x686ab8c3)
...
HXDLIN(  60)		if (::hx::IsNotNull( ::flixel::FlxG_obj::game )) {
HXLINE(  60)			_hx_tmp = ::hx::IsNull( ::flixel::FlxG_obj::game->debugger );
            		}
            		else {
HXLINE(  60)			_hx_tmp = true;
            		}
HXDLIN(  60)		if (_hx_tmp) {
HXLINE(  62)			this->_standardTraceFunction(Data,::hx::SourceInfo(HX_("flixel/system/frontEnds/LogFrontEnd.hx",c3,b8,6a,68),62,HX_("flixel.system.frontEnds.LogFrontEnd",5c,bd,97,07),HX_("advanced",a2,69,7b,3b)));
HXLINE(  63)			return;
            		}
HXLINE(  66)		if (::hx::IsNull( Style )) {
HXLINE(  68)			Style = ::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL;
            		}
HXLINE(  71)		if (!(::Std_obj::isOfType(Data,::hx::ArrayBase::__mClass))) {
HXLINE(  73)			Data = ::cpp::VirtualArray_obj::__new(1)->init(0,Data);
            		}
HXLINE(  76)		if (::flixel::FlxG_obj::game->debugger->log->add(( (::cpp::VirtualArray)(Data) ),Style,FireOnce)) {
HXLINE(  79)			if (::hx::IsNotNull( Style->errorSound )) {
HXLINE(  81)				 ::openfl::media::Sound sound = ::flixel::_hx_system::FlxAssets_obj::getSound(Style->errorSound);
HXLINE(  82)				if (::hx::IsNotNull( sound )) {
HXLINE(  84)					::flixel::FlxG_obj::sound->load(sound,null(),null(),null(),null(),null(),null(),null(),null())->play(null(),null(),null());
            				}
            			}
HXLINE(  89)			if (Style->openConsole) {
HXLINE(  91)				::flixel::FlxG_obj::debugger->set_visible(true);
            			}
HXLINE(  94)			if (::hx::IsNotNull( Style->callbackFunction )) {
HXLINE(  96)				Style->callbackFunction();
            			}
            		}
            	}
...
void LogFrontEnd_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_ba09e0c9e62cea6b_108_clear)
HXDLIN( 108)		::flixel::FlxG_obj::game->debugger->log->clear();
            	}
