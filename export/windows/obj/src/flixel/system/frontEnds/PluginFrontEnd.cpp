...
HX_LOCAL_STACK_FRAME(_hx_pos_4a20ba41f30cf210_27_add_Fmod,"flixel.system.frontEnds.PluginFrontEnd","add_Fmod",0x479de069,"flixel.system.frontEnds.PluginFrontEnd.add_Fmod","flixel/system/frontEnds/PluginFrontEnd.hx",27,0xbff70e9e)
...
bool PluginFrontEnd_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Fmod PluginFrontEnd_obj::add_Fmod( ::Fmod Plugin){
            	HX_STACKFRAME(&_hx_pos_4a20ba41f30cf210_27_add_Fmod)
HXLINE(  29)		{
HXLINE(  29)			int _g = 0;
...
HX_DEFINE_DYNAMIC_FUNC1(PluginFrontEnd_obj,add_Fmod,return )
...
::hx::Val PluginFrontEnd_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"add_Fmod") ) { return ::hx::Val( add_Fmod_dyn() ); }
		break;
	case 10:
