...
class Controls extends FlxActionSet {
    ...
    var _debug_0 = new FlxActionDigital(Action.DEBUG_0);
    ...
    public var DEBUG_0(get, never):Bool;

    inline function get_DEBUG_0() {
    ...
    public function new(name:Dynamic, scheme:Scheme) {
    ...
    public function setKeyboardScheme(scheme:KeyboardScheme, reset:Bool = true) {
        ...
        inline bindKeys(Control.DEBUG_0, [F3]);
